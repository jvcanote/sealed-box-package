/*global ajaxurl, sbx_term_ordering_params */
...
jQuery( function( $ ) {
	...
	$.sbx_add_missing_sort_handles = function() {
	...
	$( table_selector ).sortable({
		...
		helper: 'clone',
		opacity: 0.65,
		placeholder: 'sbx-term-placeholder',
		...
		update: function( event, ui ) {
			...
			$.post( ajaxurl, { action: 'sbx_term_ordering', id: termid, nextid: nexttermid, thetaxonomy: sbx_term_ordering_params.taxonomy }, function(response){
