 ...
 * @since 1.0.0
 *
 * @param string|false $service Post object or post ID of the route.
 * @return SBX_Abstract_Service|null|false
 */
function sbx_get_service( $service = false ) {
	...
	return SealedBox()->services[ $service ];
}